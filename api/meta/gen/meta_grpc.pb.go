...
const (
	Meta_Meta_FullMethodName = "/meta.v1.Meta/Meta"
)
...
func (c *metaClient) Meta(ctx context.Context, in *MetaRequest, opts ...grpc.CallOption) (*MetaResponse, error) {
	...
	err := c.cc.Invoke(ctx, Meta_Meta_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func RegisterMetaServer(s grpc.ServiceRegistrar, srv MetaServer) {
	// If the following call pancis, it indicates UnimplementedMetaServer was
...
func _Meta_Meta_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Meta_Meta_FullMethodName,
	}
